...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Researcher, Developer and Dreamer.....</h3>
            <p className="home__description">A computer science professional with a strong foundation in software development, machine learning, and web development</p>
